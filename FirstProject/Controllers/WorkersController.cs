...
namespace Community.Controllers
{
    public class WorkersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Age,Jobe,ExpertiseYears")] Worker worker)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Age,Jobe,ExpertiseYears")] Worker worker)
        {
            if (id != worker.Id)
            {
                return NotFound();
